 ...
 * @author mayur
 */
public class AircraftsMngWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form AircraftsMngWorkAreaJPanel
     */
    private JPanel cardSequenceJPanel;
    private TravelAgency travelAgency;
    public AircraftsMngWorkAreaJPanel(JPanel cardSequenceJPanel, TravelAgency travelAgency) {
        initComponents();
    ...
    public void populateAirlinersTable(){
        ...
        dtm.setRowCount(0);
        for(Aircraft aircraft: travelAgency.getAirlinerDirectory().getAirlinerList()) {
            Object[] row = new Object[3];
            row[0]=aircraft;
            row[1]=aircraft.getAirlinerHeadquaters();
            row[2]=aircraft.getAirlinerFleetSize();
    ...
    public void calculateFleetSize(){
        int count = 0;
        for(Aircraft aircraft: travelAgency.getAirlinerDirectory().getAirlinerList()){
            for(Flight flight:aircraft.getFlightList()){
                if(aircraft.getAirlinerName().equals(flight.getAirlinerName())){
                    count++;
                }
            }
            aircraft.setAirlinerFleetSize(count);
            count = 0;
        }
    ...
    private void btnCreateNewAirlinerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateNewAirlinerActionPerformed
        ...
        CreateNewAircraftJPanel panel = new CreateNewAircraftJPanel(cardSequenceJPanel,travelAgency);
    ...
    private void btnViewAirlinerDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewAirlinerDetailsActionPerformed
        ...
        int selectedRow = tblAirliner.getSelectedRow();
         if(selectedRow<0) {
           ...
           ViewAircraftDetailsJPanel panel = new ViewAircraftDetailsJPanel(cardSequenceJPanel,aircraft);
    ...
    private void btnDeleteAirlinerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteAirlinerActionPerformed
        ...
        if(selectedRow  >= 0) {
           ...
           if(dialogResult == JOptionPane.YES_OPTION) {
               Aircraft aircraft = (Aircraft)tblAirliner.getValueAt(selectedRow,0);
               travelAgency.getAirlinerDirectory().deleteAirliner(aircraft);
               populateAirlinersTable();
            }
        }
        else {
    ...
    private void btnAddFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFlightActionPerformed
        ...
        Aircraft aircraft = (Aircraft)tblAirliner.getValueAt(selectedRow,0);
        CreateNewFlightJpanel panel = new CreateNewFlightJpanel(cardSequenceJPanel, aircraft);
    ...
    private void btnSearchAirlinerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchAirlinerActionPerformed
        ...
        if(searchText.equals("") || searchText == null){
            ...
            dtm.setRowCount(0);
            for(Aircraft aircraft: travelAgency.getAirlinerDirectory().getAirlinerList()) {
            if(aircraft.getAirlinerName().equalsIgnoreCase(searchText) || aircraft.getAirlinerHeadquaters().equalsIgnoreCase(searchText)){
                Object[] row = new Object[3];
                row[0]=aircraft;
                row[1]=aircraft.getAirlinerHeadquaters();
                row[2]=aircraft.getAirlinerFleetSize();
